                ...
                <Flex maxW="600px" w="full" mx="auto" justify="center" mb={6}>
                    <ButtonGroup attached variant="solid" w="full">
                        <Button
                            ...
                            _hover={{ bg: selectedLeague === "quali" ? "#004a79" : "gray.400" }}
                        ...
                        <Button
                            ...
                            _hover={{ bg: selectedLeague === "silver" ? "#004a79" : "gray.400" }}
                        ...
                        <Button
                            ...
                            _hover={{ bg: selectedLeague === "gold" ? "#004a79" : "gray.400" }}
                        ...
                        {leaderboard && leaderboard.length > 0 ? (
                            leaderboard.map((row, index) => {
                                ...
                                if (selectedLeague === "gold") {
                                    ...
                                    badgeBg =
                                        index < Math.ceil(leaderboard.length / 2) ? "gold" : "silver";
                                } else {
